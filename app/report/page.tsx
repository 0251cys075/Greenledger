...
function ReportFormContent() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-[#F7F5F0] pt-28 pb-20 flex items-center justify-center px-6">
        <div className="max-w-md w-full card-cream p-8 rounded-2xl border-2 border-[#315C45]/30 text-center shadow-xl">
          <div className="w-16 h-16 rounded-2xl bg-[#315C45] text-[#A9BBA0] flex items-center justify-center mx-auto mb-6">
            <CheckCircle2 size={32} />
          </div>
          <h2 className="font-serif text-2xl sm:text-3xl text-[#1C1C1C] mb-3">
            {t('report.submittedTitle', 'Report Submitted to Review')}
          </h2>
          <p className="text-xs sm:text-sm text-[#718875] leading-relaxed mb-6">
          ...
          <div className="p-3.5 rounded-xl bg-[#EFECE4] text-xs font-mono text-[#1C1C1C] mb-8 text-left">
            <p><strong>{t('report.ticketIdLabel', 'Tracking Ticket')}:</strong> {ticketId}</p>
            <p className="mt-1 text-[#718875]">Audit review timeline: 3–5 business days</p>
          </div>
    ...
    <div className="min-h-screen bg-[#F7F5F0] pt-24 pb-20">
      ...
      <div className="bg-[#1B3A2B] text-[#F7F5F0] py-16 px-6 border-b border-[#315C45]">
        <div className="max-w-3xl mx-auto">
          <Link
            href="/ledger"
            className="inline-flex items-center gap-1.5 text-xs font-mono text-[#A9BBA0] hover:underline mb-4"
          >
      ...
      <div className="max-w-3xl mx-auto px-6 -mt-6">
        <form onSubmit={handleSubmit} className="card-cream p-7 sm:p-9 rounded-2xl border-2 border-[#D6D3C8] shadow-xl space-y-6">
          {/* Brand/Product */}
          <div>
            <label htmlFor="brand" className="block text-xs font-mono font-semibold text-[#315C45] uppercase tracking-wider mb-2">
              {t('report.productName', 'Product & Brand Name')} <span className="text-[#C1443E]">*</span>
            </label>
            <input
              id="brand"
              type="text"
              ...
              className="w-full px-4 py-3 text-sm bg-[#FCFAF5] border border-[#D6D3C8] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#315C45] text-[#1C1C1C]"
            />
          </div>

          {/* Claim */}
          <div>
            <label htmlFor="claim" className="block text-xs font-mono font-semibold text-[#315C45] uppercase tracking-wider mb-2">
              {t('report.claimText', 'Exact Environmental Claim Phrase')} <span className="text-[#C1443E]">*</span>
            </label>
            <textarea
              id="claim"
              required
              ...
              rows={3}
              className="w-full px-4 py-3 text-sm bg-[#FCFAF5] border border-[#D6D3C8] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#315C45] text-[#1C1C1C] resize-y"
            />
          </div>

          {/* Supporting photo */}
          <div>
            <p className="block text-xs font-mono font-semibold text-[#315C45] uppercase tracking-wider mb-2">
              Photo / Package Evidence (Optional)
            </p>
            <label
              htmlFor="file-upload"
              className="flex items-center justify-center gap-3 border-2 border-dashed border-[#D6D3C8] bg-[#FCFAF5] rounded-xl p-5 cursor-pointer hover:border-[#315C45] hover:bg-[#EFECE4] transition-all"
            >
              <Upload size={20} className="text-[#315C45]" />
              <div>
                <p className="text-sm font-medium text-[#1C1C1C]">
                  {fileName ? fileName : 'Upload packaging photo or advert screenshot'}
                </p>
                <p className="text-xs font-mono text-[#718875]">JPG, PNG, WEBP up to 10MB</p>
              </div>
            </label>
            <input
              id="file-upload"
          ...
          {/* Reason selection */}
          <div>
            <p className="block text-xs font-mono font-semibold text-[#315C45] uppercase tracking-wider mb-2.5">
              Reason for Review <span className="text-[#C1443E]">*</span>
            </p>
              ...
              {REASONS.map((r) => (
                <button
                  ...
                  className={cn(
                    ...
                    form.reason === r
                      ? 'border-[#1B3A2B] bg-[#1B3A2B] text-[#A9BBA0] font-semibold shadow-sm'
                      : 'border-[#D6D3C8] bg-[#FCFAF5] text-[#1C1C1C] hover:border-[#315C45]'
                  )}
                >
                  {r}
                </button>
          ...
          {/* Additional context */}
          <div>
            <label htmlFor="additional" className="block text-xs font-mono font-semibold text-[#315C45] uppercase tracking-wider mb-2">
          ...
          {submitError && (
            <div className="flex items-center gap-2 p-3 rounded-xl bg-[#C1443E]/10 border border-[#C1443E]/40 text-xs text-[#9E3B33] font-mono">
          ...
          <p className="text-[11px] font-mono text-[#718875] text-center leading-relaxed">
